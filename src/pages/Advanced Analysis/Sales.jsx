      ...
      <DefaultLayout>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 ">
          <div className="bg-slate-200  dark:bg-slate-800 rounded-lg">
            <SalesPieChart
              url={`${process.env.ENDPOINT}/ValueCounts/valueCounts_shipMode_Frontend`}
              chart_type="pie"
          ...
          <div className="bg-slate-200  dark:bg-slate-800 rounded-lg">
            <SalesPieChart
              url={`${process.env.ENDPOINT}/ValueCounts/valueCounts_segment_Frontend`}
              chart_type="donut"
          ...
          <div className="bg-slate-200  dark:bg-slate-800 rounded-lg">
            <SalesTreeMapChart
              url={`${process.env.ENDPOINT}/ValueCounts/valueCounts_market_Frontend`}
              title="Sales Market Wise"
            />
          </div>
          <div className="bg-slate-200  dark:bg-slate-800 rounded-lg">
            <SalesTreeMapChart
              url={`${process.env.ENDPOINT}/ValueCounts/valueCounts_region_Frontend`}
              title="Sales Region Wise"
            />
          </div>
          <div className="bg-slate-200  dark:bg-slate-800 rounded-lg">
            <SalesBarChart
              url={`${process.env.ENDPOINT}/ValueCounts/valueCounts_subCategory_Frontend`}
              title="Sales Sub Category wise"
            />
          </div>
          <div className="bg-slate-200  dark:bg-slate-800 rounded-lg">
            <SalesPieChart
              url={`${process.env.ENDPOINT}/ValueCounts/valueCounts_orderPriority_Frontend`}
              chart_type="donut"
