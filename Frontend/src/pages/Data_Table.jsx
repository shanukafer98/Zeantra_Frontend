  ...
  const updateData = useCallback(async () => {
    ...
    try {
      ...
      const updatedData = data.map((row) =>
        row._id === currentItem._id ? currentItem : row
      );
      setData(updatedData);
      ...
      if (response.data.message === "Document updated successfully") {
        ...
        // Display error alert
        toast.error("Error updating row: " + response.data.message);
      }
    } catch (error) {
    ...
    for (const _id of searchResults) {
      try {
        ...
        if (response.data.message === "Row deleted successfully") {
          ...
          toast.error("Error deleting row: Row not found");
        }
      } catch (error) {
  ...
  return (
    <>
      <DefaultLayout>
        ...
        <input
          className="border p-2 rounded mt-2 mx-2 "
          type="text"
          value={orderId}
        ...
        />
        <input
          className="border p-2 rounded mt-2 mx-3"
          type="text"
          value={productId}
        ...
        />
        <button
          className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-2 mx-2"
          onClick={search}
        >
          Search
        </button>
          ...
          <form onSubmit={updateData} className="space-y-4 my-9">
            <div className="grid grid-cols-3 gap-4">
              <input
                ...
                onChange={(e) =>
                  setCurrentItem({ ...currentItem, order_id: e.target.value })
                }
              />
              <input
                className="border-2 border-gray-300 p-2 w-full"
                type="text"
                value={currentItem.ship_date}
                onChange={(e) =>
                  setCurrentItem({ ...currentItem, ship_date: e.target.value })
                }
              />
              <input
                className="border-2 border-gray-300 p-2 w-full"
                type="text"
                value={currentItem.ship_mode}
                onChange={(e) =>
                  setCurrentItem({ ...currentItem, ship_mode: e.target.value })
                }
              />
              <input
                className="border-2 border-gray-300 p-2 w-full"
              ...
              <input
                ...
                onChange={(e) =>
                  setCurrentItem({ ...currentItem, segment: e.target.value })
                }
              />
              <input
                className="border-2 border-gray-300 p-2 w-full"
              ...
              <input
                className="border-2 border-gray-300 p-2 w-full"
                type="text"
                value={currentItem.market}
                onChange={(e) =>
                  setCurrentItem({ ...currentItem, market: e.target.value })
                }
              />
              <input
                className="border-2 border-gray-300 p-2 w-full"
                ...
                onChange={(e) =>
                  setCurrentItem({ ...currentItem, region: e.target.value })
                }
              />
              <input
                className="border-2 border-gray-300 p-2 w-full"
              ...
              <input
                ...
                onChange={(e) =>
                  setCurrentItem({ ...currentItem, sales: e.target.value })
                }
              />
              <input
                className="border-2 border-gray-300 p-2 w-full"
              ...
              <input
                className="border-2 border-gray-300 p-2 w-full"
                type="text"
                value={currentItem.order_priority}
                onChange={(e) =>
                  setCurrentItem({
                    ...currentItem,
              ...
              <input
                ...
                onChange={(e) =>
                  setCurrentItem({ ...currentItem, day: e.target.value })
                }
              />
              <input
                className="border-2 border-gray-300 p-2 w-full"
                ...
                onChange={(e) =>
                  setCurrentItem({ ...currentItem, month: e.target.value })
                }
              />
              <input
                className="border-2 border-gray-300 p-2 w-full"
